...
Dado('que deseja comprar o seguinte produto:') do |table|
...
Então('ira visualizar a pagina de checkout com os detalhes do produto') do
...
Então('ira visualizar popup que o produto está indisponível') do
